  ...
  return (
    <>
      <input
        ...
        required={required}
        className={`${className} ${errorClassName} transition-all block rounded-md text-gray-900 placeholder:text-gray-400 focus:ring-1 focus:ring-inset sm:text-sm sm:leading-6 font-poppins`}
        value={value}
